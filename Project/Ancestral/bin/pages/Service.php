...
<div class="container">
   ...
   <h1> Looking for a Service ? </h1> 
    ...
    <div class="section">
        <div class="section-icon">
            <img src="../../CYBER.png" alt="Cybersecurity Icon">
        </div>
        <div class="section-content">
    ...
    <div class="section">
        <div class="section-icon">
            <img src="../../GAME.png" alt="Game Development Icon">
        </div>
        <div class="section-content">
...
<footer class="footer"  id="footer" style = "top : 180px; position: relative;" >
  <div class="footer-top">
    <h1 class="footer-heading" id = "in">QUICK LINKS</h1>
  ...
  <div class="footer-contact">
    ...
    <div class="contact-item">
     <img src="../../LOC.png" alt="LOCATION Icon" >
      <span>Find Us - </span>
      <p>  Dhanmondi 31, A , Dhaka </p>
    </div>
    <div class="contact-item">
      <span>📧 Email Us</span>
